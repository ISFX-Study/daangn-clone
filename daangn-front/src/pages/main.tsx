    ...
    <Flex gap='middle' vertical={true} 
      ...
      <Flex gap='middle' justify='center' align='center' style={{ backgroundColor: '#FFFAE0' }}>
        <div className='service-area'>
          ...
          <Space>
            ...
            <Button type='primary' icon={ <AppleFilled /> } className='btn-daangn' onClick={onClickApp}>
              App Store
            </Button>
          </Space>
        </div>
      ...
      <Flex gap='middle' justify='center' align='center' style={{ backgroundColor: '#F9F9F9' }}>
        ...
        <div className='service-area'>
          ...
          <Button type="primary" className='btn-daangn' onClick={onClickPartTime}>
            내 근처 알바 보기
          </Button>
        </div> 
      </Flex>
      ...
      <Flex gap="middle" justify='center' align='center' style={{ backgroundColor: '#F6FDEC' }}>
        <div className='service-area'>
          ...
          <Button type="primary" className='btn-daangn' onClick={onClickCompany}>
            당근 동네업체 보기
          </Button>
        </div>
        <div>
